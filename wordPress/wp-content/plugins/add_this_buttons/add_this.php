...
function add_this_add_position() {
    // Register a binary value called "addThis_disable"
    register_setting(
        'add_this_position',
        'add_this_position',
    ...
    // Add the settings field to define the interface
    add_settings_field(
        'add_this_position_input',
        __( 'Disable AddThis Buttons' ),
        'add_this_render_position_input',
        'add_this_options_page',
        'add_this_main_settings'
    );
...
add_action( 'admin_init', 'add_this_add_position' );
...
function add_this_render_number_preferred_input(){ 
    //borrowed this from Jameson to get number options in settings 
...
function add_this_render_position_input(){ 
    $current = get_option('position', 6);
    echo '<label><input type="radio" name="position" value="left"'. checked(left, $current, false) .'/> left </label>';
    echo '<label><input type="radio" name="position" value="right"'. checked(right, $current, false) .'/> right </label>';
